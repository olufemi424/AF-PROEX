...
module.exports = {
  ...
  "_spec": "axios@0.21.4",
  "_where": "/Users/olu/Desktop/APPS/AF-PROEX",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"auth/login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePassword = exports.resetPassword = exports.requestPasswordReset = exports.logout = exports.login = exports.signup = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(email, password, $form) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            $form.append("<p>".concat(_context2.t0.message, "</p>"));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            console.log('Error logging out', _context3.t0);
...
var requestPasswordReset = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(email, $form) {
    var res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            res = _context4.sent;
            if (res.data.status === 'success') $form.append("<p>".concat(res.data.message, "</p>"));
            _context4.next = 10;
            break;
          ...
          case 7:
            ...
            console.log('Error logging out', _context4.t0);
  ...
  return function requestPasswordReset(_x8, _x9) {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(password, passwordConfirm, $form) {
    var url_string, token, res;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            url_string = window.location.href.split('/');
            token = url_string[url_string.length - 1];
            _context5.prev = 2;
            _context5.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 9:
            ...
            $form.append("<p>".concat(_context5.t0.message, "</p>"));
            console.log('Error logging out', _context5.t0);
...
var updatePassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(email, passwordCurrent, password, passwordConfirm, $form) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            $form.append("<p>".concat(_context6.t0.message, "</p>"));
  ...
  return function updatePassword(_x13, _x14, _x15, _x16, _x17) {
...
var updatePasswordForm = document.querySelector('.form--update-password');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _login.login)(email, password, loginForm);
  });
}
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _login.resetPassword)(password, passwordConfirm, resetPasswordForm);
  });
}
...
if (forgetPasswordForm) {
  forgetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _login.requestPasswordReset)(email, forgetPasswordForm);
  });
}
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, _login.updatePassword)(email, passwordCurrent, password, passwordConfirm, updatePasswordForm);
  });
}
